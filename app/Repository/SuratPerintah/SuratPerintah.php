...
class SuratPerintah extends BaseModel
{
  ...
  public function akrPegawai()
  {
    return $this->hasOne('App\Repository\AngkaKredit\AkrPegawai', 'id_surat_perintah');
  }
  ...
  public function type_pkpt()
  {
    return $this->belongsTo('App\Repository\SuratPerintah\TypePkpt', 'is_pkpt');
  }
}
