...
class PegawaiService
{
  ...
  public static function get_inspektur_pembantu_by_wilayah($id_wilayah)
  {
    $pegawai = self::get_pegawai_by_peran(['inspektur_pembantu', 'pengendali_teknis', 'inspektur']);
  ...
  {
    $pegawai = self::get_pegawai_by_peran(['pengendali_teknis', 'inspektur_pembantu']);
  ...
  {
    $pegawai = self::get_pegawai_by_peran(['ketua_tim', 'pengendali_teknis', 'inspektur_pembantu']);
