...
use App\Http\Controllers\AngkaKredit\AngkaKreditController;
use App\Http\Controllers\AngkaKredit\TambahAngkaKredit;
...
Route::middleware(['auth'])->group(function () {
  ...
  Route::prefix('angka-kredit')->group(function(){
    Route::prefix('perhitungan-angka-kredit')->group(function(){
      ...
      Route::get('/tambah-angka-kredit', 'AngkaKredit\TambahAngkaKredit@add');
    ...
    Route::prefix('pilih-angka-kredit')->group(function() {
      Route::get('/', [AngkaKreditController::class, 'pilihAngkaKredit']);
    });
    
    Route::get('/table-auditor-angka-kredit/{id}', [TambahAngkaKredit::class, 'tableAuditor']);
    Route::get('/tambah-angka-kredit', 'AngkaKredit\TambahAngkaKredit@index');

    Route::get('/edit-angka-kredit/get_sub_unsur/{id}', 'AngkaKredit\EditAngkaKredit@getSubUnsur');
    Route::get('/edit-angka-kredit/get_butir_kegiatan/{id}', 'AngkaKredit\EditAngkaKredit@getButirKegiatan');
    Route::get('/edit-angka-kredit/get_satuan/{id}', 'AngkaKredit\EditAngkaKredit@satuan');
    Route::post('/edit-angka-kredit/tambah/{id_sp}', 'AngkaKredit\EditAngkaKredit@store');
    Route::get('/edit-angka-kredit/{id_sp}/{id}/{no_surat}/{peran}', 'AngkaKredit\EditAngkaKredit@index');
    Route::post('/edit-angka-kredit/update/{id}/{id_sp}', 'AngkaKredit\EditAngkaKredit@update');
