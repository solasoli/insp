...
@section('content')
    ...
    <form class="form-layout form-layout-5" id='form-review' style="padding-top:0" method="post"
        ...
        <div class="br-pagebody">
            ...
            @foreach($data->program_kerja->skpd as $row)
                <div class="row">
                    <div class="col-lg-12 widget-2 px-0">
                        <div class="card shadow-base">
                            ...
                            <div class="card-body">
                                <table border="1" class="table">
                                    <tbody>
                                        <tr class="bg-cyan">
                                            ...
                                            <td class="pd1" rowspan="2">Paraf {{ $row->name }}</td>
                                        ...
                                        @foreach($data->audit_kertas_kerja as $row)
                                            @foreach($row->kertas_kerja_ikhtisar->where('is_compilation', 1) as $rw)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px">{{ !is_null($tindak_lanjut) ? $tindak_lanjut->tindak_lanjut  : '' }}</td>
                                                    <td style="width:10px">{!! !is_null($tindak_lanjut) && $tindak_lanjut->s ? "<i class='fa fa-check'></i>" : '' !!}</td>
                                                    <td style="width:10px">{!! !is_null($tindak_lanjut) && $tindak_lanjut->d ? "<i class='fa fa-check'></i>" : '' !!}</td>
                                                    <td style="width:10px">{!! !is_null($tindak_lanjut) && $tindak_lanjut->b ? "<i class='fa fa-check'></i>" : '' !!}</td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                                @php
                                ...
                                <div>
                                    <h6>Review</h6>
                                    <textarea name="review_tindak_lanjut" class='text-wizard' id="review_tindak_lanjut" rows="10" cols="80">
                                        {{ !is_null($data->tindak_lanjut_review) ? $data->tindak_lanjut_review->review : '' }}
                                    </textarea>
                                </div>
                            </div>
                        </div>
