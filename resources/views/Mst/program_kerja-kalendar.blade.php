...
<div class="card-body" style="position: relative;">
  @foreach($list_arr as $idx => $row)
  <div>
    <!-- <div style="width:10px;height: 10px; background: {{ $row['backgroundColor'] }}; border: 1px solid {{ $row['borderColor'] }}; color: {{ $row['textColor'] }}; display: inline-block;"></div>
  </div> -->
  @endforeach
