        ...
        <div class="tab-content">
          ...
          <table class="table table-striped table-bordered" style="border: 3px solid #dee2e6">
            <tr>
              ...
              @foreach($akrPegawai AS $val)
                @foreach($sp AS $spr) 
            <tr>
              <td width="23%">Sp : {{$spr->no_surat}}<br> tanggal : <br> Jumlah HP : {{$val->jumlah_hari}}<br>Jam : {{$val->jam}}<br>Posisi : {{$val->peran}}</td>
              <td width="11%"></td>
              <td width="11%"></td>
              <td width="11%"></td>
              <td width="11%"></td>
              <td width="11%"></td>
              <td width="11%"></td>
              <td width="11%"><a href="/angka-kredit/review-sekretariat-dupak"><button class="btn btn-info w-100">Review</button></a>
