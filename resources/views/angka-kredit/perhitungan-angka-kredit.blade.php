  ...
  $('#oTableAvail').DataTable({
    language: {
      ...
      columns: [
        ...
        { data: 'program_kerja.sasaran', name: 'program_kerja.sasaran', render: function(data, type, row){
         
          return row.program_kerja != null ? row.program_kerja.sasaran : "-";
        }},
        ...
        { data: null, name:null, orderable: false, render: function ( data, type, row ) {
          ...
          return_button += 
            ` <td class="text-center">
              <a href="{{ url('/angka-kredit/table-auditor-angka-kredit/${data.id}') }}"><button class="btn btn-info mb-1" >Tambah Angka Kredit</button></a>
